...
const navItems = [
  ...
  { label: "All QR Codes", href: "/super-admin/qr-codes", icon: QrCode },
    ...
    <>
      ...
      >
        ...
        <div className="flex h-16 items-center justify-between px-4">
          ...
          {collapsed && (
            <Link href="/super-admin" className="mx-auto flex items-center justify-center">
              <img
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/ScanDz%20logo-7J1ybfWOdR79DjGOswyhMbITWPE8Q3.png"
                alt="ScanDz"
                className="h-8 w-8"
        ...
        {!collapsed && (
          <div className="mx-3 mb-2 rounded-lg border border-sidebar-border bg-sidebar-accent/60 px-3 py-2">
            ...
            <p className="text-sm font-semibold text-sidebar-primary">Super Admin</p>
          </div>
        )}
...
export function SuperAdminMobileMenuButton({ onClick }: { onClick: () => void }) {
  return (
    <button
      onClick={onClick}
